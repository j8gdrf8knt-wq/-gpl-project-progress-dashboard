...
function submitExpense(){
  ...
  if(expenseId){
    ...
    apiFetch(`/api/projects/${currentProjectId}/expenses/${expenseId}/update/`, {
      method: 'PUT',
    ...
    apiFetch(`/api/projects/${currentProjectId}/expenses/save/`, {
      method: 'POST',
      headers: {'Content-Type': 'application/json'},
      body: JSON.stringify({date, category, description, amount, remarks})
...
function deleteExpense(expenseId){
  ...
  apiFetch(`/api/projects/${currentProjectId}/expenses/${expenseId}/delete/`, {
    method: 'DELETE'
  }).then(r=>{
    if(r.ok){
      const p = PROJECTS[currentProjectId];
